...
export default function Dashboard(props) {
	...
	return (
		<ChakraProvider theme={theme} resetCss={false}>
			<Sidebar routes={routes.slice(0, routes.length-2)} logoText={'PURITY UI DASHBOARD'} display='none' sidebarVariant={sidebarVariant} {...rest} />
			<MainPanel w={{ base: '100%', xl: 'calc(100% - 275px)' }}>
				...
				<Configurator secondary={getActiveNavbar(routes)} isOpen={isOpen} onClose={onClose} isChecked={fixed} 
					onSwitch={(value) => {
						setFixed(value);
					}}
